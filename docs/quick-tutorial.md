...
However if you scale out your Prometheus instance, Thanos is exactly helping with that. 
...
* Compactor: compacts, downsamples and applies retention on the data stored in remote storage.
